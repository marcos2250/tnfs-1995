...
void CloseDirectDraw() {
	if (g_pDDSBack)  IDirectDraw_Release(g_pDDSBack);
	if (g_pDDSFront) IDirectDraw_Release(g_pDDSFront);
	if (g_pDD)       IDirectDraw_Release(g_pDD);
}
